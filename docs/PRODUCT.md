...
**Statut :** en cours d’implémentation (go 2026-08-28). Focus = défaut ; Inbox liste = mode Beeper.  
...
Pour usage perso d’abord (dogfood). Pas un concurrent Beeper « tous les réseaux ».
...
- Multiplateforme (iOS) — Mac d’abord
- Monétisation / store
