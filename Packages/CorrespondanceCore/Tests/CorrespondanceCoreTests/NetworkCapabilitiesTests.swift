...
final class NetworkCapabilitiesTests: XCTestCase {
  ...
  func testAjouterQuelquUnSuitLesPontsQuiOntUnGhostComposable() {
    for network in [MessageNetwork.whatsapp, .instagram, .messenger, .twitter, .slack, .telegram, .signal] {
  ...
  func testLeVocalEstOffertPartoutSaufSurIMessageEtX() {
    for network in [MessageNetwork.whatsapp, .instagram, .messenger, .slack, .telegram, .signal, .selfNote] {
