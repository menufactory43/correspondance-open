...
public struct MatrixTransactionLedger: Sendable {
  ...
  public mutating func transactionID(forLocalID localID: String) -> String {
  ...
  public func attachmentTransactionID(base: String, index: Int) -> String {
    "\(base)-att\(index)"
  }

  public func isUsed(_ transactionID: String) -> Bool {
    used.contains(transactionID)
  }

  /// À appeler **après** un envoi réussi seulement : un échec réseau doit rester rejouable.
  public mutating func markUsed(_ transactionID: String) {
