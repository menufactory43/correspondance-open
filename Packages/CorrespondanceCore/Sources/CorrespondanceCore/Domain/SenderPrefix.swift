...
public enum SenderPrefix {
  ...
  public static func previewLine(_ body: String, senderName: String?, isGroup: Bool) -> String {
  ...
  /// ou une URL en deux.
  public static func splittingLegacySenderPrefix(_ text: String) -> (senderName: String, body: String)? {
