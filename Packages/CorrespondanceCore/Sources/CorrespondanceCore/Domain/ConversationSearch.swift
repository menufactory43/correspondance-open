...
public enum ConversationSearch {
  ...
  public static func matches(_ conversation: Conversation, query: String, messageBlob: String?) -> Bool {
  ...
  public static func blob(for messages: [ChatMessage]) -> String {
  ...
  public static func matchingMessageIDs(in messages: [ChatMessage], query: String) -> [String] {
  ...
  public static func highlightRanges(in text: String, query: String) -> [Range<String.Index>] {
    let needle = fold(query)
