...
struct InstagramSessionCookies: Equatable, Sendable {
  ...
  static let requiredNames: Set<String> = ["sessionid", "ds_user_id", "csrftoken"]
  ...
  static let optionalNames: Set<String> = ["mid", "ig_did", "rur", "shbid", "shbts"]
  ...
  static func isInstagramDomain(_ domain: String) -> Bool {
