...
enum DemoMode {
  ...
  static func iMessageConversations(now: Date = .now) -> [Conversation] {
    [
      Conversation(
        ...
        preview: String(localized: "On dit 19 h 30 devant le cinéma ?"), lastMessageAt: now.addingTimeInterval(-6 * 60),
      ...
      Conversation(
        id: rando, network: .iMessage, address: "rando", title: String(localized: "Rando dimanche"),
        preview: String(localized: "Nadia : Je prends les sandwichs 🥪"), lastMessageAt: now.addingTimeInterval(-52 * 60),
      ...
      Conversation(
        ...
        preview: String(localized: "Bien reçu, merci mon grand."), lastMessageAt: now.addingTimeInterval(-3 * 3600),
      ...
      Conversation(
        ...
        preview: String(localized: "Je t'envoie le lien ce soir"), lastMessageAt: now.addingTimeInterval(-26 * 3600),
        unreadCount: 0, isArchived: false, transportKey: "demo", isGroup: false,
  ...
  static func iMessageMessages(now: Date = .now) -> [String: [ChatMessage]] {
    ...
    return [
      camille: [
        m("c1", camille, String(localized: "Tu as vu la bande-annonce du film de jeudi ?"), 95, me: false, sender: "Camille"),
        m("c2", camille, String(localized: "Oui ! Ça a l'air très bien. On y va ?"), 88, me: true),
        m("c3", camille, String(localized: "Carrément."), 40, me: false, sender: "Camille",
          reactions: [MessageReaction(emoji: "❤️", senders: [String(localized: "Moi")], isMine: true)]),
        m("c4", camille, String(localized: "On dit 19 h 30 devant le cinéma ?"), 6, me: false, sender: "Camille"),
      ],
      julia: [
        m("j1", julia, "Oi meffysto! Tudo bem?", 22, me: false, sender: "Júlia"),
        m("j2", julia, String(localized: "Oui ! Et toi ? On se voit toujours ce week-end ?"), 18, me: true),
        m("j3", julia, "A gente se vê no domingo? Minha mãe também vem, ela não come carne.", 14, me: false, sender: "Júlia"),
      ],
      rando: [
        m("r1", rando, String(localized: "Dimanche, départ 8 h du parking de la gare ?"), 180, me: false, sender: "Nadia"),
        m("r2", rando, String(localized: "Ok pour moi. Il y a un point d'eau sur le chemin ?"), 170, me: true),
        m("r3", rando, String(localized: "Oui, à mi-parcours. Prenez quand même 1,5 L."), 160, me: false, sender: "Louis"),
        m("r4", rando, String(localized: "Je m'occupe des fruits 🍎"), 90, me: false, sender: "Inès"),
        m("r5", rando, String(localized: "Je prends les sandwichs 🥪"), 52, me: false, sender: "Nadia",
          reactions: [MessageReaction(emoji: "👍", senders: ["Louis", "Inès"])]),
      ],
      papa: [
        m("p1", papa, String(localized: "Je t'ai envoyé les photos du jardin, tu me diras."), 250, me: false, sender: "Papa"),
        m("p2", papa, String(localized: "Elles sont superbes. Le cerisier a bien pris !"), 200, me: true),
        m("p3", papa, String(localized: "Bien reçu, merci mon grand."), 180, me: false, sender: "Papa"),
      ],
      theo: [
        m("t1", theo, String(localized: "Tu avais parlé d'un article sur les fontes variables ?"), 1600, me: false, sender: "Théo"),
        m("t2", theo, String(localized: "Je t'envoie le lien ce soir"), 1560, me: true),
      ],
    ]
  }
}
