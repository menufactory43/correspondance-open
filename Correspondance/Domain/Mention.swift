...
enum MentionParser {
  ...
  static func activeToken(in text: String) -> Token? {
  ...
  static func matches(_ candidates: [MentionCandidate], query: String) -> [MentionCandidate] {
  ...
  /// reprendre la phrase.
  static func insert(_ candidate: MentionCandidate, replacing token: Token, in text: String) -> String {
