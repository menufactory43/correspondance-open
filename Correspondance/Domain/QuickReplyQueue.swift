...
enum QuickReplyQueue {
  /// Le fil que le panneau ouvre à froid.
  static func defaultConversationID(in queue: [Conversation], selectedID: String?) -> String? {
    let unread = queue
  ...
  static func step(from current: String?, in ids: [String], by delta: Int) -> String? {
