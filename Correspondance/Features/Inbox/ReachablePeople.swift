...
// `identifiesByPhone`, `readableAddress` et `networkAndReadableAddress` vivent
// dans le noyau (`Domain/ReadableAddress.swift`) : l'iPhone en a besoin pour
// sa fiche de contact fusionné, comme le Mac.
